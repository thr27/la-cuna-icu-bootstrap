<# https://www.powershellgallery.com/packages/WinSSH/0.9.8/Content/Public%5CInstall-WinSSH.ps1
    .SYNOPSIS
...
Install-WinSSH -SkipWinCapabilityAttempt -GiveWinSSHBinariesPathPriority -ConfigureSSHDOnLocalHost -DefaultShell powershell -GitHubInstall